var col = x2coMessage.getMessage( {
	_stdLrgCtgNm		: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.stdLrgCtgNm"		// 표준대분류명
	, _stdMidCtgNm		: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.stdMidCtgNm"		// 표준중분류명
	, _goodsNo			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.goodsNo"			// 상품번호
	, _goodsNm			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.goodsNm"			// 상품명
	, _optnNm			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.optnNm"			// 단품명
	, _norPrc			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.norPrc"			// 정상가
	, _salePrc			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.salePrc"			// 판매가
	, _stkQty			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.stkQty"			// 재고수량
	, _saleStatCdNm		: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.saleStatCdNm"		// 판매상태
	, _prestNm			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.prestNm"			// 증정품명
	, _deliProcTypCdNm	: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.deliProcTypCdNm"	// 배송처리유형
	, _dispCtgNm		: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.dispCtgNm"		// 전시카테고리
	, _brandNm			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.brandNm"			// 브랜드명
	, _entrNm			: "orderMgmt.manualOrder.goodsSearch.keyWord.grid.entrNm"			// 협력사명
});

$.namespace("wishListGrid.settings");
wishListGrid.settings = {
    fields : [
		{ fieldName: "itmNo"				, dataType: "text" }// 단품번호
		, { fieldName: "buyQtyLmtYn"		, dataType: "text" }// 구매수량제한여부
		, { fieldName: "minLmtQty"			, dataType: "text" }// 최소구매수량
		, { fieldName: "maxLmtQty"			, dataType: "text" }// 최대구매수량
		...
		, { fieldName: "salePrc"			, dataType: "text" }// 판매가
		, { fieldName: "stkQty"				, dataType: "text" }// 재고수량
    ...
    , validations : []
    , props : {
        form : "wishListSearchForm"                         // 서버로 전달할 데이터 Form ID값
        , paging : true          // 페이지네이션 사용 여부
        , action : _baseUrl + "order/orderReception.getWishListPopup.do" // Request URL
