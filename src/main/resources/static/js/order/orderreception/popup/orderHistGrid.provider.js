...
$.namespace("orderHistGrid.settings");
orderHistGrid.settings = {
    fields : [
    ...
    , validations : []
    , props : {
        form : "orderHistSearchForm"                         // 서버로 전달할 데이터 Form ID값
        , paging : true          // 페이지네이션 사용 여부
        , action : _baseUrl + "order/orderReception.getGoodsOrderHistListPopup.do" // Request URL
