$.namespace("standardDisplayCategoryTree.eventhandler");
standardDisplayCategoryTree.eventhandler = {
    // 초기화
    init : function () {
        this.treeLoading();
    },
    ...
    treeLoading : function () {
        ...
        common.Ajax.sendRequest(
            "get",
            _baseUrl + "display/standardDisplayCategoryConnect.getStandardDisplayCategoryConnectTree.do",
            null,
            function ( nodes ) {
                that.zTreeObj = $.fn.zTree.init($("#standardDisplayCategoryTree"), setting, nodes);
    ...
    ,setCategoryInfoList( treeNode ){
		...
		//표준 분류 기본 정보 조회
		standardDisplayCategoryConnectGrid.eventhandler.setting(leafCtgYn, stdCtgNo);
	}
}
