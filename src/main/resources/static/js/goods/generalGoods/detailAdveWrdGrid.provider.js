var detailAdveWrdGridCol = x2coMessage.getMessage({
...
$.namespace('detailAdveWrdGrid.settings')
detailAdveWrdGrid.settings = {
    fields : [
    ...
    ,columns : [
        {
            ...
            header: { text: detailAdveWrdGridCol.adveWrd + '*' }
        },
        {
            // 적용시작일자
            name: 'aplyStrDt',
            ...
            datetimeFormat : "yyyy-MM-dd",
            header: { text: detailAdveWrdGridCol.aplyStrDt + '*'  }
        },
        {
            // 적용종료일자
            name: 'aplyEndDt',
            ...
            datetimeFormat : "yyyy-MM-dd",
            header: { text: detailAdveWrdGridCol.aplyEndDt + '*'  }
        },
        {
            // 사용여부
            name: 'useYn',
            fieldName: 'useYn',
            width: 100,
            header: {text: detailAdveWrdGridCol.useYn },
            sortable: false,
            editable : false,
            renderer: {
                type: "check",
