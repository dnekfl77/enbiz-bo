var detailAssocGoodsGridCol = x2coMessage.getMessage({
...
$.namespace('detailAssocGoodsGrid.settings')
detailAssocGoodsGrid.settings = {
    fields : [
    ...
    ,columns : [
        {
            ...
            fieldName: 'sortSeq',
            width : 80,
            header: { text: detailAssocGoodsGridCol.sortSeq + '*' },
            editor: {
                type: 'number',
        ...
        },
        {
            ...
            header: { text: detailAssocGoodsGridCol.asctGoodsNo }
        },
        {
            // 연관상품명
            name: 'asctGoodsNm',
            ...
            header: { text: detailAssocGoodsGridCol.asctGoodsNm }
        },
        {
            // 판매상태
            name: 'saleStatCdNm',
            ...
            editable : false,
            styleName: 'disable-column',
            header: { text: detailAssocGoodsGridCol.saleStatCdNm }
        }
    ]
    ,validations : [
