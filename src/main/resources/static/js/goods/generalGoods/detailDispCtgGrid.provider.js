var detailDispCtgGridCol = x2coMessage.getMessage({
...
$.namespace('detailDispCtgGrid.settings')
detailDispCtgGrid.settings = {
    fields : [
    ...
    ,columns : [
        {
            ...
            header: { text: detailDispCtgGridCol.siteNm }
        },
        {
            // 전시카테고리 구조
            ...
            header: { text: detailDispCtgGridCol.dispCtgHierarchy }
        },
        {
            // 대표 카테고리 여부
            name: 'repCtgYn',
            fieldName: 'repCtgYn',
            width : 150,
            header: { text: detailDispCtgGridCol.repCtgYn},
            editable : false,
            renderer: {
                type: "check",
                trueValues: "Y",
