var prestGridCol = x2coMessage.getMessage({
    ...
    ,columns : [
        {
            ...
            header: { text: prestGridCol.prestNm + '*' }
        },
        {
            // 적용시작일자
            name: 'aplyStrDt',
            ...
            datetimeFormat : "yyyy-MM-dd",
            header: { text: prestGridCol.aplyStrDt + '*'}
        },
        {
            // 적용종료일자
            name: 'aplyEndDt',
            ...
            datetimeFormat : "yyyy-MM-dd",
            header: { text: prestGridCol.aplyEndDt + '*'}
        },
        {
            // 사용여부
            name: 'useYn',
            fieldName: 'useYn',
            width: 100,
            header: {text: prestGridCol.useYn},
            sortable: false,
            editable : false,
            renderer: {
                type: "check",
