$.namespace("counselingTemplateCommonPopupGrid.eventhandler");
counselingTemplateCommonPopupGrid.eventhandler = {
    // 초기화
    init : function () {
        this.argCheck();
        this.gridLoading();
    ...
    bindButtonEvent : function(){
        ...
        $("#btn_common_popup_apply").click(function() {
            self.onApply();
        });

        $("#btn_common_popup_close").click(function() {
            window.close();
        });
    },
    ...
    gridEvent : {
        ...
        ,onCellDblClicked : function(grid, clickData) {
            ...
            counselingTemplateCommonPopupGrid.eventhandler.returnData(clickData.dataRow);
        }
    },
