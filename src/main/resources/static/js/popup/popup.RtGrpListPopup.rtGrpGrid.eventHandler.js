$.namespace("rtGrpGrid.eventhandler");
rtGrpGrid.eventhandler = {
    // 초기화
    init : function () {
        this.gridLoading();
    ...
    bindButtonEvent : function(){
        ...
        $('#btn_popup_init').click(function() {
            $('#rtGrpGridForm')[0].reset();
        });

        $("#rtGrpGridForm").keypress(function (e){
            if (e.which == 13){
    ...
    gridEvent : {
        ...
        ,onCellDblClicked : function(grid, clickData) {
            ...
            rtGrpGrid.eventhandler.returnData( clickData.dataRow );
        }
    },
    onApply : function () {
