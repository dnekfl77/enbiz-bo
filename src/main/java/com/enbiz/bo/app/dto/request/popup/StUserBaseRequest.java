 ...
 * ==========================
 */
@Alias("StUserBaseRequest")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class StUserBaseRequest extends BaseCommonEntity {

    //===============[View Argument]===============//
    @NotNull
    @NotEmpty
    String argWorkStatCd ;  //근무상태 ( 01 : 재직중 , 02 : 퇴사 )
	...
	private	String rcntUseDtm;				// 최근사용일시 timestamp NULL
	private	String pwdCntnFailCnt;			// 비밀번호연속실패수 numeric(10) NOT NULL DEFAULT 0
	private	String lstPwdChgDtm;			// 최종비밀번호변경일시 timestamp NULL
    ...
    private String workStatNm       ;   //  근무상태코드명
    private String orgRolNm         ;   //  조직역할코드명
    private String orgTypNm         ;   //  업무그룹코드명
    private String userGbNm         ;   //  사용자구분코드명
