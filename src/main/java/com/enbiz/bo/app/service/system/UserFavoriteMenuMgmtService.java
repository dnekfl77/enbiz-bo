...
public interface UserFavoriteMenuMgmtService {
     ...
     * @throws Exception
     */
	List<UserFavoriteMenuResponse> getUserFavoriteMenuList(UserFavoriteMenuRequest userFavoriteMenuRequest) throws Exception;
     ...
     * @throws Exception
     */
	int getUserFavoriteMenuListCount(UserFavoriteMenuRequest userFavoriteMenuRequest) throws Exception;
	 ...
	 * @throws Exception
	 */
	void saveUserFavoriteMenu(RealGridCUDRequest<StUserFvtInfo> realGridCUD) throws Exception;
