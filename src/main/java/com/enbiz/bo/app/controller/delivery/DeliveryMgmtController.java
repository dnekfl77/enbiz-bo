...
import com.enbiz.bo.app.service.delivery.DeliveryInquiryService;
...
public class DeliveryMgmtController extends BaseController {

	private final DeliveryMgmtService deliveryManagementService;
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.fullOrderInquiryList.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/delivery/deliveryManagement.getFullOrderInquiryList.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RealGridSearch
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.fullOrderInquiryExcelDownload.do")
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.deliveryInquiryList.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/delivery/deliveryManagement.getDeliveryInquiryList.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RealGridSearch
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.getDeliveryExcelDownload.do")
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.deliveryDetailPopup.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/delivery/deliveryManagement.getDeliveryGoodsList.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RealGridSearch
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/deliveryManagement.individualSendInstructList.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/delivery/deliveryManagement.getIndividualSendInstructList.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	@RealGridSearch
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/delivery/deliveryManagement.sendInstruct.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
