...
import com.enbiz.bo.app.service.delivery.IndividualSendInstructService;
...
public class IndividualSendInstructController extends BaseController {
//
...
//	 * @throws Exception
//	 */
//	@RequestMapping("/delivery/individualSendInstruct.deliveryRegnZipList.do")
//	public String deliveryRegnZipList(Model model) {
//		Map<String, List<StStdCd>> codeList = codeService.getStStdCd("PR023");
//		List<String> regnGripList = deliveryManagementService.getRgnGrpList();
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value = "/delivery/individualSendInstruct.getDeliRegnByZipCdList.do", produces = "application/json;charset=UTF-8")
//	@ResponseBody
//	@RealGridSearch
//	public String getDeliRegnByZipCdList(EtDeliRegnByZipCdRequest etDeliRegnByZipCdRequest) throws Exception {
//		int totalCount = deliveryManagementService.getDeliRegnByZipCdListCount(etDeliRegnByZipCdRequest);
//		List<EtDeliRegnByZipCdResponse> deliRegnByZipCdList =  deliveryManagementService.getDeliRegnByZipCdList(etDeliRegnByZipCdRequest);
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value = "/delivery/individualSendInstruct.getRegnPostNoList.do", produces = "application/json;charset=UTF-8")
//	@ResponseBody
//	@RealGridSearch
//	public String getRegnPostNoList(EtDeliRegnByZipCdRequest etDeliRegnByZipCdRequest) throws Exception {
//		int totalCount = deliveryManagementService.getRegnPostNoListCount(etDeliRegnByZipCdRequest);
//		List<EtDeliRegnByZipCdResponse> regnByZipCdList = deliveryManagementService.getRegnPostNoList(etDeliRegnByZipCdRequest);
...
//	 * @throws Exception
//	 */
//	@PostMapping(value = "/delivery/individualSendInstruct.cdDeliRegnByZipCd.do", produces = MediaType.APPLICATION_JSON_VALUE)
//	@RealGridCUDResponse
//	@ResponseBody
//	public JSONResponseEntity cudDeliRgnZipNoList( @RealGridCUD(type = EtDeliRegnByZipCdCudRequest.class) RealGridCUDRequest<EtDeliRegnByZipCdCudRequest> realGridCUD) throws Exception {
//		List<EtDeliRegnByZipCdCudRequest> createList = realGridCUD.getCreate(),	deleteList = realGridCUD.getDelete();
//		deliveryManagementService.registCUD(createList, deleteList);
//
...
//	 * @throws Exception
//	 */
//	@GetMapping("/delivery/individualSendInstruct.fullOrderInquiryList.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value = "/delivery/individualSendInstruct.getFullOrderInquiryList.do", produces = MediaType.APPLICATION_JSON_VALUE)
//	@ResponseBody
//	@RealGridSearch
...
//	 * @throws Exception
//	 */
//	@GetMapping("/delivery/individualSendInstruct.fullOrderInquiryExcelDownload.do")
...
//	 * @throws Exception
//	 */
//	@GetMapping("/delivery/individualSendInstruct.deliveryInquiryList.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value = "/delivery/individualSendInstruct.getDeliveryInquiryList.do", produces = MediaType.APPLICATION_JSON_VALUE)
//	@ResponseBody
//	@RealGridSearch
...
//	 * @throws Exception
//	 */
//	@GetMapping("/delivery/individualSendInstruct.getDeliveryExcelDownload.do")
...
//	 * @throws Exception
//	 */
//	@GetMapping("/delivery/individualSendInstruct.deliveryDetailPopup.do")
...
//	 * @throws Exception
//	 */
//	@RequestMapping(value = "/delivery/individualSendInstruct.getDeliveryGoodsList.do", produces = MediaType.APPLICATION_JSON_VALUE)
//	@ResponseBody
//	@RealGridSearch
...
//
	 ...
	 * @throws Exception
	 */
	@GetMapping("/delivery/individualSendInstruct.individualSendInstructListView.do")
	public String individualSendInstructList(Model model) throws Exception{
		...
		model.addAttribute("codeList", codeList);
		model.addAttribute("nonMembersNumber", env.getProperty("delivery.nonMembersNumber"));
		return "views/delivery/individualSendInstructListView";
	}
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = "/delivery/individualSendInstruct.getIndividualSendInstructList.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public RealGridListResponse getIndividualSendInstructList(IndividualSendInstructRequest individualSendInstructRequest) throws Exception {
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/delivery/individualSendInstruct.sendInstruct.do", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
